...
export function RecipeOverviewCurry({
  route,
  navigation,
}: {
  route: any;
  ...
  const testRecipe = {
    ...
    image: 'HELP!', // aaggh
    shortDescription: 'A classic hearty Japanese dish!',
    ingredients: [
      {
    ...
    additionalDetails: `Make sure not to burn the curry sauce. Sub with tofu or potato for vegan option.`,
  };
      ...
      <ScrollView style={styles.overviewContainer}>
        <View>
          <View style={styles.recipeImageContainer}>
            {
              <Image
                source={require('../../assets/foodImages/Curry.png')}
